...
function materialsIndex() {
  ...
  const cards = MATS.map((m) => {
    ...
    return '<div class="mt-card"><h3>' + esc(m.material) + '</h3><div class="val">' + esc(src) + '<span class="basis ' + esc(basis) + '">' + esc(basis) + '</span></div><div class="meta">' + meta + '</div>' +
  ...
  return '<!DOCTYPE html>\n<html lang="en" data-theme="dark"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Transformer Materials Intelligence — Copper, Aluminium, CRGO | TransformerPath</title>' +
    ...
    '<p class="lead">Input-cost signal for transformer sourcing. Copper and aluminium use the LME 3-month official settlement as a <b>latest reference</b> (dated, sourced, not a live feed). CRGO and other materials have no public daily index — they are shown as unavailable with the reasons explained, rather than invented.</p>' +
...
function crgoPage() {
  ...
  const table = '<table class="cr-tbl"><thead><tr><th>Market</th><th>Grade</th><th>Thickness</th><th>Price</th><th>Currency/unit</th><th>Basis</th><th>Observation</th></tr></thead><tbody>' +
    '<tr><td>China</td><td class="na">GRADE NOT SPECIFIED</td><td class="na">—</td><td class="na">No verified reference</td><td class="na">—</td><td class="na">—</td><td class="na">—</td></tr>' +
    '<tr><td>India</td><td class="na">GRADE NOT SPECIFIED</td><td class="na">—</td><td class="na">No verified reference</td><td class="na">—</td><td class="na">—</td><td class="na">—</td></tr>' +
    '<tr><td>Europe</td><td class="na">GRADE NOT SPECIFIED</td><td class="na">—</td><td class="na">No verified reference</td><td class="na">—</td><td class="na">—</td><td class="na">—</td></tr>' +
    '<tr><td>USA</td><td class="na">GRADE NOT SPECIFIED</td><td class="na">—</td><td class="na">No verified reference</td><td class="na">—</td><td class="na">—</td><td class="na">—</td></tr>' +
    '<tr><td>Japan / Korea</td><td class="na">GRADE NOT SPECIFIED</td><td class="na">—</td><td class="na">No verified reference</td><td class="na">—</td><td class="na">—</td><td class="na">—</td></tr>' +
    '<tr><td>Other (reliable)</td><td class="na">GRADE NOT SPECIFIED</td><td class="na">—</td><td class="na">No verified reference</td><td class="na">—</td><td class="na">—</td><td class="na">—</td></tr>' +
    '</tbody></table>';
