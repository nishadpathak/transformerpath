...
const GO_DEEPER = {
  fundamentals: { v: 1, t: 'The Transformer Path — A Practical Guide: From Specification to Service' },
  classification: { v: 1, t: 'The Transformer Path — A Practical Guide' },
  core: { v: 6, t: 'Transformer Manufacturing & Quality' },
  windings: { v: 6, t: 'Transformer Manufacturing & Quality' },
  insulation: { v: 7, t: 'Transformer Insulation, Materials & Dielectrics' },
  cooling: { v: 8, t: 'Transformer Components & Accessories' },
  construction: { v: 6, t: 'Transformer Manufacturing & Quality' },
  drytype: { v: 9, t: 'Special-Purpose & Emerging Transformers' },
  materials: { v: 7, t: 'Transformer Insulation, Materials & Dielectrics' },
  design: { v: 1, t: 'The Transformer Path — A Practical Guide' },
  losses: { v: 1, t: 'The Transformer Path — A Practical Guide' },
  testing: { v: 16, t: 'Transformer Standards, Quality & Test Frameworks' },
  standards: { v: 16, t: 'Transformer Standards, Quality & Test Frameworks' },
  vectorgroups: { v: 1, t: 'The Transformer Path — A Practical Guide' },
  inrush: { v: 1, t: 'The Transformer Path — A Practical Guide' },
  special: { v: 9, t: 'Special-Purpose & Emerging Transformers' },
  sitelife: { v: 15, t: 'Transformer Installation, Commissioning, Service & Life Extension' },
  protection: { v: 10, t: 'Protection, Control, Power Electronics & Grid Integration' },
  procurement: { v: 13, t: 'Transformer Economics, Procurement & Supply Chain' },
  aftersales: { v: 15, t: 'Transformer Installation, Commissioning, Service & Life Extension' },
  bushings: { v: 8, t: 'Transformer Components & Accessories' },
  tapchangers: { v: 8, t: 'Transformer Components & Accessories' },
  stresscontrol: { v: 7, t: 'Transformer Insulation, Materials & Dielectrics' },
  fireenv: { v: 14, t: 'Transformer Safety, Sustainability & Environment' },
  powerdesign: { v: 1, t: 'The Transformer Path — A Practical Guide' },
};
