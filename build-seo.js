...
const META = {
  ...
  'High-Voltage Insulators': { slug: 'high-voltage-insulators', t: 'High-Voltage Insulators & Bushing Shells', std: 'IEC 60672, IEC 61462, IEC 60273, IEC 60815', app: 'Electro-porcelain and composite silicone rubber hollow core insulator shells, station post insulators and suspension disc strings for transformers and substations up to 1200 kV.',
    faq: [['What is the difference between an Insulator and a Transformer Bushing?', 'A bushing is an active lead-through apparatus with an internal capacitive condenser grading core carrying current through the tank wall. An insulator is the external ceramic or composite dielectric shell providing surface creepage distance and flashover withstand.'],
      ['When are composite silicone insulators preferred over porcelain?', 'Composite silicone insulators provide superior hydrophobic pollution performance in coastal or industrial environments, lighter weight, seismic resilience, and non-shattering explosion safety.']] },
  ...
  'Insulation Materials': { slug: 'insulation-materials', t: 'Transformer Insulation Materials', std: 'IEC 60893, IEC 60641, IEC 60763, IEC 61061', app: 'Pressboard, laminated wood, DDP/DPE, aramid and paper for lead exits, barriers, end rings, and winding insulation.',
...
<link rel="stylesheet" href="../style.css?v=13"><link rel="preconnect" href="https://www.googletagmanager.com" crossorigin><link rel="preconnect" href="https://www.google-analytics.com">
