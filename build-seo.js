...
(function () {
  var MAIN = ['', 'intel.html', 'events.html', 'webinars.html', 'manufacturers.html', 'grids.html',
    ...
    'applications.html', 'knowledge.html', 'standards.html', 'markets.html', 'projects.html', 'tenders.html', 'compare.html', 'case-studies.html', 'contribute.html', 'accessories.html', 'intelligence.html', 'methodology.html', 'exhibitions.html', 'utilities.html', 'vendors.html', 'company.html', 'archive.html'];
  var urls = [];
  ...
  try {
    fs.readdirSync('accessories').forEach(function (d) {
      if (fs.existsSync('accessories/' + d + '/index.html')) urls.push('https://transformerpath.com/accessories/' + d + '/');
    });
  } catch (e) {}
  try {
  ...
  try {
    fs.readdirSync('tenders').forEach(function (d) {
      if (fs.existsSync('tenders/' + d + '/index.html')) urls.push('https://transformerpath.com/tenders/' + d + '/');
    });
  } catch (e) {}
  try {
